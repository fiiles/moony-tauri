    ...
    <div className="p-6 md:p-8 lg:p-10 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <SummaryCard
          ...
          value={formatCurrencyRaw(totalMarketValue, {
        ...
        <SummaryCard
          ...
          value={formatCurrencyRaw(totalMonthlyRent, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 0,
          })}
            ...
            <div className="rounded-lg border">
              <Table>
                <TableHeader className="[&_th]:bg-muted/50">
                  <TableRow>
                    <TableHead
                      className="text-xs font-medium uppercase text-muted-foreground cursor-pointer select-none hover:bg-muted/50"
                  ...
                  {sortedRealEstates?.map((re) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right data-value">
                        {formatCurrency(
                          convertToCzK(
                            Number(re.purchasePrice),
                            re.purchasePriceCurrency as CurrencyCode
                          )
                        )}
                      </TableCell>
                      <TableCell className="text-right data-value">
                        {formatCurrency(
                          convertToCzK(
                            Number(re.marketPrice),
                            re.marketPriceCurrency as CurrencyCode
                          )
                        )}
                      </TableCell>
