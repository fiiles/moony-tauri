  ...
  if (appStatus === 'needs_setup') {
    return (
      <div className="min-h-screen relative">
        ...
        />
        <LanguagePicker language={selectedLanguage} onLanguageChange={handleLanguageChange} />
        ...
        <Dialog open={!!recoveryKey} onOpenChange={(open) => !open && clearRecoveryKey()}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>{t('recoveryKeyModal.description')}</DialogDescription>
            </DialogHeader>
