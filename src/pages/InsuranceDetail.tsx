...
import { ArrowLeft, Shield, Calendar, DollarSign, Trash2, Pencil, Building2 } from 'lucide-react';
...
export default function InsuranceDetail() {
  ...
  const oneTimePaymentInCzk =
    policy.oneTimePayment && Number(policy.oneTimePayment) > 0
      ? convertToCzK(
          Number(policy.oneTimePayment),
          (policy.oneTimePaymentCurrency as CurrencyCode) || 'CZK'
        )
      : null;
                      ...
                      >
                        ...
                        <span className="text-muted-foreground">
                          {formatCurrency(
                            convertToCzK(
                              Number(limit.amount),
                              (limit.currency as CurrencyCode) || 'CZK'
                            )
                          )}
                        </span>
                      </div>
