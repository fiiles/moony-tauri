...
export function AddRealEstateModal({ realEstate, trigger }: AddRealEstateModalProps) {
  ...
  const form = useForm<InsertRealEstate>({
    ...
    defaultValues: {
      ...
      recurringCosts:
        (realEstate?.recurringCosts as any)?.map((cost: any) => ({
          ...cost,
          ...
          >
            ...
            <FormSection title={t('modal.add.financing')}>
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">{t('modal.add.loanRemark')}</p>
              </div>
            </FormSection>
            ...
            <FormSection title={t('modal.add.linkInsurances')}>
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">{t('modal.add.insuranceRemark')}</p>
              </div>
            </FormSection>
