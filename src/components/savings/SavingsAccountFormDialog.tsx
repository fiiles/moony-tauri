      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-2">
            ...
            />
            <p className="text-xs text-muted-foreground">{t('form.terminationDateHelp')}</p>
          </div>
          ...
          <div className="flex items-start space-x-3 p-3 rounded-lg border">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">{t('modal.zonesHelp')}</p>
            </div>
          </div>
          ...
          {hasZoneDesignation && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground mb-3">{t('modal.zonesDescription')}</p>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isLoading || !name || !balance || (isEditMode && !account)}
          >
            {isLoading
              ? tc('status.saving')
              : isEditMode
