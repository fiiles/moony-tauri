...
export function CryptoTransactionsModal({
  investment,
  open,
  onOpenChange,
}: CryptoTransactionsModalProps) {
                ...
                <TableBody>
                  {transactions.map((tx) => (
                    <TableRow key={tx.id} className="row-interactive">
                      ...
                      <TableCell className="text-right">
                        {formatAmount(parseFloat(tx.pricePerUnit), tx.currency)} {tx.currency}
                      </TableCell>
                      <TableCell>{tx.currency}</TableCell>
                      <TableCell className="text-right">
                        {formatAmount(
                          parseFloat(tx.pricePerUnit) * parseFloat(tx.quantity),
                          tx.currency
                        )}{' '}
                        {tx.currency}
                      </TableCell>
