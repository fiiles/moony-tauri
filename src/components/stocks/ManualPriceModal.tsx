...
export function ManualPriceModal({ open, onOpenChange, investment }: ManualPriceModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Set a manual price override for this holding.</DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="rounded-lg bg-muted p-3 text-sm">
              ...
              <div className="text-xs text-muted-foreground mt-1 text-right">
                Formula: {form.watch('price') || '0'} × {investment?.quantity?.toFixed(4) || '0'}{' '}
                shares
              </div>
            </div>
