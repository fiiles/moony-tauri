      ...
      <Table>
        <TableHeader className="[&_th]:bg-muted/50">
          <TableRow>
            ...
            >
              <span className="flex items-center justify-end">
                {t('table.avgPurchasePrice')}
                <SortIcon column="avgPurchasePrice" />
              </span>
            </TableHead>
            <TableHead
              className="text-right cursor-pointer select-none hover:bg-muted/50"
              ...
              return (
                <TableRow key={asset.id} className="cursor-pointer hover:bg-muted/50">
                  ...
                  <TableCell className="text-right">
                    {formatCurrency(
                      convertToCzK(parseFloat(asset.marketPrice), asset.currency as CurrencyCode)
                    )}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatCurrency(
                      convertToCzK(
                        parseFloat(asset.averagePurchasePrice),
