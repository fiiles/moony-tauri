        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3 p-3 rounded-lg border">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">{t('form.zonesHelp')}</p>
            </div>
          </div>
          ...
          {!hasZoneDesignation && (
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder="0.00"
              />
              <p className="text-xs text-muted-foreground">{t('form.apyHelp')}</p>
            </div>
          )}
          ...
          {hasZoneDesignation && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground mb-3">{t('form.zonesDescription')}</p>
