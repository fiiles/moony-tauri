...
export function InstitutionCombobox({ institutions, value, onChange }: InstitutionComboboxProps) {
  ...
  const filteredInstitutions = useMemo(() => {
    ...
    return institutions.filter((inst) => inst.name.toLowerCase().includes(searchLower));
  }, [institutions, search]);
          ...
          <div onWheel={(e) => e.stopPropagation()}>
            <Command shouldFilter={false}>
              ...
              <CommandList className="max-h-[250px]">
                <CommandEmpty>{t('form.noBankFound', 'No bank found.')}</CommandEmpty>
                <CommandGroup>
                  {/* None option */}
                  <CommandItem
                    value="none"
